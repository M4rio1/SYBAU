...
export default function TuningPanel({ options, onChange }: Props) {
  const handleChange = (key: keyof TuningOptions, value: number | undefined) => {
    onChange({ ...options, [key]: value });
  };

  return (
    <div className="absolute top-[120%] right-0 mt-2 w-72 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 rounded-xl shadow-xl shadow-black/10 animate-in fade-in zoom-in-95 p-4 z-[60]">
